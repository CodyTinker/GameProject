#include <GameEngine/Utility/ParallelTask.hpp>

//Keeping here merely as a reference. This object is not at all
//dynamic in its functionality and only performs a specific task.
